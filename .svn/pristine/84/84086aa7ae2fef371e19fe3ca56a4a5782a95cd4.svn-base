...
const actions = {
	...
	getAdminList({ rootState, commit }, opt) { //管理员列表
		return new Promise((resolve, reject) => {
	...
	insertAdmin({ rootState, commit }, opt) { //管理员添加
		return new Promise((resolve, reject) => {
	...
	chekAdmin({ rootState, commit }, opt) { //管理员用户验证
		return new Promise((resolve, reject) => {
			api.post(`${config.https.api}/adminxex/systemsaccountsloginstypes/list`, opt).then(data => {
				if (data.data) {
					resolve(data.data);
	...
	deleteAdmin({ rootState, commit }, opt) { //管理员删除
		return new Promise((resolve, reject) => {
    ...
    updateAdmin({ rootState, commit }, opt) { //管理员修改
		return new Promise((resolve, reject) => {
	...
	getArtTypeList({ rootState, commit }, opt) { //文章类型列表
		return new Promise((resolve, reject) => {
	...
	insertArtType({ rootState, commit }, opt) { //文章类型添加
		return new Promise((resolve, reject) => {
	...
	updateArtType({ rootState, commit }, opt) { //文章类型修改
		return new Promise((resolve, reject) => {
	...
	getArtSourceList({ rootState, commit }, opt) { //文章来源列表
		return new Promise((resolve, reject) => {
	...
	insertArtSource({ rootState, commit }, opt) { //文章来源添加
		return new Promise((resolve, reject) => {
	...
	updateArtSource({ rootState, commit }, opt) { //文章来源修改
		return new Promise((resolve, reject) => {
	...
	getArtList({ rootState, commit }, opt) { //文章管理列表
		return new Promise((resolve, reject) => {
	...
	insertArt({ rootState, commit }, opt) { //文章管理添加
		return new Promise((resolve, reject) => {
	...
	updateArt({ rootState, commit }, opt) { //文章管理编辑
		return new Promise((resolve, reject) => {
	...
	deleteArt({ rootState, commit }, opt) { //文章管理删除
		return new Promise((resolve, reject) => {
